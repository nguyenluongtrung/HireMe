export const SUCCESS_TITLE_MESSAGE = 'Thành công';
export const WARNING_TITLE_MESSAGE = 'Cảnh báo';
export const ERROR_TITLE_MESSAGE = 'Lỗi';
...
export const TOAST_PROFILE_UPDATE_SUCCESS_MESSAGE = "Cập nhật hồ sơ thành công";
export const TOAST_PROFILE_UPDATE_ERROR_MESSAGE = "Cập nhật hồ sơ thất bại";
