...
const Toast = ({
  ...
  return (
    <div
      aria-live="assertive"
      className={`pointer-events-none z-[100] toast-container inset-0 flex px-4 py-6 sm:p-6 ${
        fixedToast ? "fixed" : ""
            ...
            <div className="p-4">
              <div className={`flex items-center ${className}`}>
                ...
                <div className="ml-4 flex flex-shrink-0">
                  <button
                    type="button"
                    className="inline-flex rounded-md text-gray-400 hover:text-gray-500 hover:cursor-pointer focus:outline-none"
                    onClick={() => {
                      hideToast();
                    }}
                  >
